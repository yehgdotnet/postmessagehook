...
Fiddler rule to inject hook
	...
	if (oSession.oResponse.headers.ExistsAndContains("Content-Type", "html")) {
		...
		oSession.oResponse.headers.Remove("X-WebKit-CSP");

		var hook = '<script src=//sentinel.appcheck-ng.com/static/pm/hook.js></script>'
		oBody = hook + oBody
...
*/
var url = "https://sentinel.appcheck-ng.com/static/pm/logger.html";
var id = "appcheck_postmessage_logging_frame";
var do_not_hook = "sentinel.appcheck-ng.com";
